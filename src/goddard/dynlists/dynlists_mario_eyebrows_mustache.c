...
static s16 verts_player_eyebrow_right[][3] = {
...
static struct GdVtxData vtx_player_eyebrow_right = { ARRAY_COUNT(verts_player_eyebrow_right), 0x1, verts_player_eyebrow_right };

static u16 facedata_player_eyebrow_right[][4] = {
...
static struct GdFaceData faces_player_eyebrow_right = { ARRAY_COUNT(facedata_player_eyebrow_right), 0x1, facedata_player_eyebrow_right };

struct DynList dynlist_player_eyebrow_right_shape[] = {
    BeginList(),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_RIGHT_EYEBROW_VTX_GROUP),
        LinkWithPtr(&vtx_player_eyebrow_right),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_RIGHT_EYEBROW_TRI_GROUP),
        LinkWithPtr(&faces_player_eyebrow_right),
...
static s16 verts_player_eyebrow_left[][3] = {
...
static struct GdVtxData vtx_player_eyebrow_left = { ARRAY_COUNT(verts_player_eyebrow_left), 0x1, verts_player_eyebrow_left };

static u16 facedata_player_eyebrow_left[][4] = {
...
static struct GdFaceData faces_player_eyebrow_left = { ARRAY_COUNT(facedata_player_eyebrow_left), 0x1, facedata_player_eyebrow_left };

struct DynList dynlist_player_eyebrow_left_shape[] = {
    BeginList(),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_LEFT_EYEBROW_VTX_GROUP),
        LinkWithPtr(&vtx_player_eyebrow_left),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_LEFT_EYEBROW_TRI_GROUP),
        LinkWithPtr(&faces_player_eyebrow_left),
...
static s16 verts_player_mustache[][3] = {
...
static struct GdVtxData vtx_player_mustache = { ARRAY_COUNT(verts_player_mustache), 0x1, verts_player_mustache };

static u16 facedata_player_mustache[][4] = {
...
static struct GdFaceData faces_player_mustache = { ARRAY_COUNT(facedata_player_mustache), 0x1, facedata_player_mustache };

struct DynList dynlist_player_mustache_shape[] = {
    BeginList(),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_MUSTACHE_VTX_GROUP),
        LinkWithPtr(&vtx_player_mustache),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_MUSTACHE_TRI_GROUP),
        LinkWithPtr(&faces_player_mustache),
