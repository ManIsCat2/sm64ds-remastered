...
static s16 verts_player_eye_right[][3] = {
...
static struct GdVtxData vtx_player_eye_right = { ARRAY_COUNT(verts_player_eye_right), 0x1, verts_player_eye_right };

static u16 facedata_player_eye_right[][4] = {
...
static struct GdFaceData faces_player_eye_right = { ARRAY_COUNT(facedata_player_eye_right), 0x1, facedata_player_eye_right };

struct DynList dynlist_player_eye_right_shape[] = {
    BeginList(),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_RIGHT_EYE_VTX_GROUP),
        LinkWithPtr(&vtx_player_eye_right),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_RIGHT_EYE_TRI_GROUP),
        LinkWithPtr(&faces_player_eye_right),
...
static s16 verts_player_eye_left[][3] = {
...
static struct GdVtxData vtx_player_eye_left = { ARRAY_COUNT(verts_player_eye_left), 0x1, verts_player_eye_left };

static u16 facedata_player_eye_left[][4] = {
...
static struct GdFaceData faces_player_eye_left = { ARRAY_COUNT(facedata_player_eye_left), 0x1, facedata_player_eye_left };

struct DynList dynlist_player_eye_left_shape[28] = {
    BeginList(),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_LEFT_EYE_VTX_GROUP),
        LinkWithPtr(&vtx_player_eye_left),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_LEFT_EYE_TRI_GROUP),
        LinkWithPtr(&faces_player_eye_left),
