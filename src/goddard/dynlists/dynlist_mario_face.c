...
static s16 player_Face_VtxData[][3] = {
...
static struct GdVtxData player_Face_VtxInfo = { ARRAY_COUNT(player_Face_VtxData), 0x1, player_Face_VtxData };

static u16 player_Face_FaceData[][4] = {
...
static struct GdFaceData player_Face_FaceInfo = { ARRAY_COUNT(player_Face_FaceData), 0x1, player_Face_FaceData };

struct DynList dynlist_mario_face_shape[] = {
    BeginList(),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_FACE_VTX_GROUP),
        LinkWithPtr(&player_Face_VtxInfo),

    MakeDynObj(D_DATA_GRP, DYNOBJ_MARIO_FACE_TRI_GROUP),
        LinkWithPtr(&player_Face_FaceInfo),
