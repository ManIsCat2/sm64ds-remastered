...
void player_bonk_reflection(struct PlayerState *, u32);
...
u32 player_update_quicksand(struct PlayerState *, f32);
u32 player_push_off_steep_floor(struct PlayerState *, u32, u32);
u32 player_update_moving_sand(struct PlayerState *);
u32 player_update_windy_ground(struct PlayerState *);
