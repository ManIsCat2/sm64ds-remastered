COURSE_ACTS(COURSE_BOB, _(" 1 BOB-OMB BATTLEFIELD"),
       _("BIG BOB-OMB ON THE SUMMIT")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("5 SILVER STARS!"),
       _("BIG BOB-OMB'S REVENGE")         , _("MARIO WINGS TO THE SKY")        , _("FIND THE 8 RED COINS"),
       _("BEHIND CHAIN-CHOMP'S GATE"))
...
COURSE_ACTS(COURSE_WF, _(" 2 WHOMP'S FORTRESS"),
       ...
       _("SWITCH STAR OF THE FORTRESS"))

COURSE_ACTS(COURSE_JRB, _(" 3 JOLLY ROGER BAY"),
       _("PLUNDER IN THE SUNKEN SHIP")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE IN THE OCEAN CAVE"),
       _("BLAST TO THE STONE PILLAR")     , _("RED COINS ON THE SHIP AFLOAT")  , _("SWITCH STAR OF THE BAY"),
       _("THROUGH THE JET STREAM"))

COURSE_ACTS(COURSE_CCM, _(" 4 COOL, COOL MOUNTAIN"),
       _("SLIP SLIDIN' AWAY")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
       _("FROSTY SLIDE FOR 8 RED COINS")  , _("SNOWMAN'S LOST HIS HEAD")       , _("MARIO'S SUPER WALL KICK"),
       _("SWITCH STAR OF COOL, COOL MOUNTAIN"))
...
COURSE_ACTS(COURSE_SSL, _(" 8 SHIFTING SAND LAND"),
       ...
       _("STAND TALL ON THE FOUR PILLARS"), _("TOX BOX SWITCH STAR")           , _("PYRAMID PUZZLE"),
       _("FREE FLYING FOR 8 RED COINS"))

COURSE_ACTS(COURSE_DDD, _(" 9 DIRE, DIRE DOCKS"),
       _("BOARD BOWSER'S SUB")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
       _("THROUGH THE JET STREAM")        , _("KOOPA SURFIN' SWITCH STAR")     , _("INSIDE THE CAGE"),
       _("THE MANTA RAY'S REWARD"))

COURSE_ACTS(COURSE_SL, _("10 SNOWMAN'S LAND"),
       _("SNOWMAN'S BIG HEAD")            , _("CHILL WITH THE BULLY")          , _("YOSHI'S ICE SCULPTURE"),
       _("WHIRL FROM THE FREEZING POND")  , _("SNOWMAN'S SILVER STAR")         , _("INTO THE IGLOO"),
       _("RED COINS IN THE HOUSE"))

COURSE_ACTS(COURSE_WDW, _("11 WET-DRY WORLD"),
       _("SHOCKING ARROW LIFTS!")         , _("TOP O' THE TOWN")               , _("5 SECRETS IN THE SHALLOWS & SKY"),
       _("EXPRESS ELEVATOR--HURRY UP!")   , _("GO TO TOWN FOR THE RED COINS")  , _("QUICK RACE THROUGH DOWNTOWN!"),
       _("SOAKED SILVER STARS!"))
...
COURSE_ACTS(COURSE_TTM, _("12 TALL, TALL MOUNTAIN"),
       ...
       _("MYSTERIOUS MOUNTAINSIDE")       , _("BLAST TO THE LONELY MUSHROOM")  , _("5 SECRETS OF THE MOUNTAIN"),
       _("BREATHTAKING VIEW FROM THE BRIDGE"))
...
COURSE_ACTS(COURSE_THI, _("13 TINY-HUGE ISLAND"),
       ...
       _("KLEPTO THE CONDOR")             , _("WIGGLER'S RED COINS")           , _("MAKE WIGGLER SQUIRM"),
       _("SWITCH STAR ON THE ISLAND"))

COURSE_ACTS(COURSE_TTC, _("14 TICK TOCK CLOCK"),
       _("LUIGI IN THE CAGE")             , _("THE PENDULUM SWITCH STAR")      , _("GET A HAND"),
       _("STOMP ON THE THWOMP")           , _("TIMED JUMPS ON MOVING BARS")    , _("STOP TIME FOR RED COINS"),
       _("TICK TOCK SILVER STARS"))
...
COURSE_ACTS(COURSE_RR, _("15 RAINBOW RIDE"),
       ...
       _("SWITCH STAR OF THE MANOR"))

SECRET_STAR(COURSE_SI, _("   SUNSHINE ISLES"))
