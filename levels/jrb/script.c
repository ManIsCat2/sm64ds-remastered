...
static const LevelScript script_func_local_3[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR_SWITCH,       /*pos*/   -50, -2966, -7100, /*angle*/ 0, 90, 0, /*behParam*/ BPARAM2(7), /*bhv*/ bhvStarSwitch,         /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE, /*pos*/ -3650, -2666, -2900, /*angle*/ 0,  0, 0, /*behParam*/ BPARAM1(6), /*bhv*/ bhvStarSwitchSpawnCondition, /*acts*/ ALL_ACTS),
    RETURN(),
};
...
const LevelScript level_jrb_entry[] = {
    ...
    FREE_LEVEL_POOL(),
    PLAYER_POS(/*area*/ 1, /*yaw*/ 90, /*pos*/ -6750, 1126, 1482),
