...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_geo_000488),
		...
		PLAYER_POS(0x01, 135, 2105, 4293, -4414),
		...
		OBJECT_WITH_ACTS(MODEL_BLACK_BOBOMB, 2453, 4295, -4893, 0, -146, 0, 0, bhvBobomb, ACT_1),
		OBJECT_WITH_ACTS(MODEL_BLACK_BOBOMB, 2270, 4295, -4893, 0, -146, 0, 0, bhvBobomb, ACT_1),
