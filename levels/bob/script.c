...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_geo_000488),
    	...
    	OBJECT_WITH_ACTS(MODEL_STAR, 7014, 1990, -5376, 0, 0, 0, BPARAM2(2), bhvSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_STAR, -4296, 770, 2310, 0, 0, 0, BPARAM2(2), bhvSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_STAR, -1509, 975, 5093, 0, 0, 0, 0, bhvSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_STAR, -6298, 1077, -5274, 0, 0, 0, 0, bhvSilverStar, ACT_3),
		OBJECT_WITH_ACTS(MODEL_STAR,  362,  973, 1941, 0, 0, 0, 0, bhvSilverStar, ACT_3),
