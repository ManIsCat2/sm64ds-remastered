...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_DL_CANNON_LID, -5704, -920, 5606, 0, -180, 0, 0x00000000, bhvCannonClosed, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6 | ACT_7),
		OBJECT(MODEL_BOB_CHAIN_CHOMP_GATE, 1484, -280, 417, 0, -32, 0, 0x00000000, bhvChainChompGate),
		OBJECT(MODEL_RED_SWITCH, -2304, -1048, -3635, 0, 27, 0, 0x00000000, bhvFloorSwitchGrills),
		...
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -6093, -1048, 6656, 0, 0, 0, DIALOG_003 << 16, bhvBobombBuddy, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6 | ACT_7),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -5632, -895, 5939, 0, 0, 0, DIALOG_002 << 16, bhvBobombBuddyOpensCannon, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6 | ACT_7),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -4314, -1048, 5119, 0, 0, 0, DIALOG_003 << 16, bhvBobombBuddy, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6 | ACT_7),
		OBJECT_WITH_ACTS(MODEL_CHAIN_CHOMP, 410, -280, 1946, 0, 0, 0, 0x00000000, bhvChainChomp, ACT_1 | ACT_2),
		OBJECT_WITH_ACTS(MODEL_GOOMBA, 5326, -50, 3695, 0, -45, 0, 0x00000000, bhvGoomba, ACT_1 | ACT_2 | ACT_3 | ACT_5 | ACT_6 | ACT_7),
		OBJECT_WITH_ACTS(MODEL_GOOMBA, -205, -1048, 4321, 0, -90, 0, 0x00000000, bhvGoomba, ACT_1 | ACT_2 | ACT_3 | ACT_5 | ACT_6 | ACT_7),
