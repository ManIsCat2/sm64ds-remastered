...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_geo_000488),
		...
		OBJECT_WITH_ACTS(MODEL_DL_CANNON_LID, -5704, 130, 5606, 0, -180, 0, BPARAM2(0x00), bhvCannonClosed, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, 1512, 3837, -5659, 0, -147, 0, BPARAM2(BBALL_BP_STYPE_BOB_UPPER), bhvTtmBowlingBallSpawner, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_NONE, 433, 2826, -5558, 0, -151, 0, BPARAM2(BBALL_BP_STYPE_BOB_LOWER), bhvBobBowlingBallSpawner, ACT_1 | ACT_2),
		OBJECT_WITH_ACTS(MODEL_NONE, 433, 2826, -5558, 0, -151, 0, BPARAM2(BBALL_BP_STYPE_BOB_LOWER), bhvTtmBowlingBallSpawner, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -6093, 2, 6656, 0, 0, 0, BPARAM2(DIALOG_003), bhvBobombBuddy, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -5632, 156, 5939, 0, 0, 0, 0, bhvBobombBuddyOpensCannon, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -4314, 2, 5119, 0, 0, 0, DIALOG_003 << 16, bhvBobombBuddy, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_GOOMBA, 5326, 1000, 3695, 0, -45, 0, 0x00000000, bhvGoomba, ACT_1 | ACT_2 | ACT_3 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_GOOMBA, -205, 2, 4321, 0, -90, 0, 0x00000000, bhvGoomba, ACT_1 | ACT_2 | ACT_3 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_KOOPA_WITH_SHELL, 4098, 769, 6348, 0, 0, 0, BPARAM2(KOOPA_BP_NORMAL), bhvKoopa, ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_BREAKABLE_BOX, -4404, 1026, -662, 0, 45, 0, 0x00000000, bhvBreakableBox, ACT_4),
		OBJECT_WITH_ACTS(MODEL_BREAKABLE_BOX, -4961, 1026, -768, 0, 0, 0, 0x00000000, bhvBreakableBox, ACT_4),
