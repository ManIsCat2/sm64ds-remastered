...
const LevelScript level_cotmc_entry[] = {
	...
	AREA(1, cotmc_area_1),
		...
		OBJECT(MODEL_MIST, 430, -1048, -7383, 0, 0, 0, 0x00000000, bhvWaterMist),
		OBJECT(MODEL_STAR, 0, 2177, -6144, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, 0, -1048, 0, 0, -180, 0, BPARAM2(WARP_NODE_0A), bhvAirborneWarp),
		MARIO_POS(0x01, -180, 0, -1048, 0),
