...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 4, rec_room_geo),
        ...
        WARP_NODE(WARP_NODE_12, LEVEL_BOB, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        WARP_NODE(WARP_NODE_13, LEVEL_BOB, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        WARP_NODE(WARP_NODE_14, LEVEL_BOB, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        P_WARP_NODE(WARP_NODE_12, LEVEL_BOB, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        P_WARP_NODE(WARP_NODE_13, LEVEL_BOB, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        P_WARP_NODE(WARP_NODE_14, LEVEL_BOB, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
