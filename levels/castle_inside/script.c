...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 4, rec_room_geo),
		...
		WARP_NODE(WARP_NODE_00, LEVEL_CASTLE, 4, WARP_NODE_00, WARP_NO_CHECKPOINT),
		WARP_NODE(WARP_NODE_01, LEVEL_CASTLE, 4, WARP_NODE_01, WARP_NO_CHECKPOINT),
        WARP_NODE(WARP_NODE_02, LEVEL_CASTLE, 4, WARP_NODE_02, WARP_NO_CHECKPOINT),
        ...
        WARP_NODE(WARP_NODE_03, LEVEL_SSL, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        WARP_NODE(WARP_NODE_04, LEVEL_SSL, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        WARP_NODE(WARP_NODE_05, LEVEL_SSL, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        P_WARP_NODE(WARP_NODE_03, LEVEL_SSL, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        P_WARP_NODE(WARP_NODE_04, LEVEL_SSL, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        P_WARP_NODE(WARP_NODE_05, LEVEL_SSL, 1, WARP_NODE_0A, WARP_NO_CHECKPOINT),
        ...
        ROOMS(/*surfaceRooms*/ rec_room_rooms),
