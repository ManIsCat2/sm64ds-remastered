...
DEFINE_COURSES_END()
DEFINE_BONUS_COURSE(COURSE_BITDW, 0x22222220) // (16) Bowser in the Dark World
DEFINE_BONUS_COURSE(COURSE_BITFS, 0x34444404) // (17) Bowser in the Fire Sea
DEFINE_BONUS_COURSE(COURSE_BITS, 0x34444404) // (18) Bowser in the Sky
DEFINE_BONUS_COURSE(COURSE_PSS, 0x24444404) // (19) The Princess's Secret Slide
DEFINE_BONUS_COURSE(COURSE_COTMC, 0x22222220) // (20) Cavern of the Metal Cap
DEFINE_BONUS_COURSE(COURSE_TOTWC, 0x04444404) // (21) Tower of the Wing Cap
DEFINE_BONUS_COURSE(COURSE_VCUTM, 0x24444404) // (22) Vanish Cap under the Moat
DEFINE_BONUS_COURSE(COURSE_WMOTR, 0x04444404) // (23) Wing Mario over the Rainbow
DEFINE_BONUS_COURSE(COURSE_SA, 0x24444404) // (24) Secret Aquarium
DEFINE_BONUS_COURSE(COURSE_CAKE_END, 0x44444404) // (25) The End (Cake Scene)
