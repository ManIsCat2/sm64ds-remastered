...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		WARP_NODE(WARP_NODE_05, LEVEL_CASTLE, 4, WARP_NODE_0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -1523, -968, 6485, 0, -180, 0, 0x28, bhvIntroScene),
		...
		OBJECT(MODEL_MIPS, -5027, -699, 5312, 0, 0, 0, BPARAM2(MIPS_BP_CASTLE_KEY), bhvMipsCastle),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_METAL_DOOR, 3252, -1559, -932, 0, 225, 0, BPARAM2(2), bhvDoorWarp),
