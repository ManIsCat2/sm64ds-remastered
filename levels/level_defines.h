...
DEFINE_LEVEL("EXT1 YOKO SCRL", LEVEL_BITDW, COURSE_BITDW, bitdw, sky, 20000, 0x00, 0x00, 0x00, _, sCamBitDW) 
...
DEFINE_LEVEL("URANIWA", LEVEL_CASTLE_COURTYARD, COURSE_NONE, castle_courtyard, outside, 20000, 0x00, 0x00, 0x00, _, sCamCastleCourtyard) 
DEFINE_LEVEL("EXT4 MINI SLID", LEVEL_PSS, COURSE_PSS, pss, mountain, 20000, 0x28, 0x28, 0x28, _, _) 
DEFINE_LEVEL("IN THE FALL", LEVEL_COTMC, COURSE_COTMC, cotmc, cave, 20000, 0x00, 0x00, 0x00, _, sCamCotMC) 
...
DEFINE_LEVEL("SI", LEVEL_SI, COURSE_SI, si, generic, 20000, 0x00, 0x00, 0x00, _, sCamSi) 
