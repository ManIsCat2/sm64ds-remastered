...
static const LevelScript script_func_local_1[] = {
		...
		OBJECT(MODEL_WF_SLIDING_PLATFORM, 3840, 1075, -768, 0, -90, 0, BPARAM2(WF_SLID_BRICK_PTFM_BP_MOV_VEL_15), bhvWFSlidingPlatform),
		OBJECT(MODEL_WF_SLIDING_PLATFORM, 3840, 1075, -1792, 0, -90, 0, BPARAM2(WF_SLID_BRICK_PTFM_BP_MOV_VEL_10), bhvWFSlidingPlatform),
		OBJECT(MODEL_WF_SLIDING_PLATFORM, 3840, 1075, -2816, 0, -90, 0, BPARAM2(WF_SLID_BRICK_PTFM_BP_MOV_VEL_20), bhvWFSlidingPlatform),
