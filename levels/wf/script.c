...
static const LevelScript script_func_local_1[] = {
		...
		OBJECT(MODEL_STAR, 4601, 256, 97, 0, 0, 0, BPARAM1(STAR_INDEX_ACT_3), bhvStar),
		OBJECT(MODEL_STAR, 4601, 256, 97, 0, 0, 0, BPARAM1(STAR_INDEX_ACT_5), bhvStar),
		...
		OBJECT(MODEL_WF_BREAKABLE_WALL_RIGHT, 512, 2176, 2176, 0, 0, 0, 0, bhvWFBreakableWallRight),
		...
		OBJECT(MODEL_WF_GIANT_POLE, -2560, 2560, -262, 0, 0, 0, 0, bhvGiantPole),
		...
		OBJECT(MODEL_WF_KICKABLE_BOARD, 13, 3584, -1408, 0, 135, 0, 0, bhvKickableBoard),
		...
		OBJECT(MODEL_WF_SLIDING_PLATFORM, 3840, 1075, -768, 0, 0, 0, BPARAM2(WF_SLID_BRICK_PTFM_BP_MOV_VEL_15), bhvWFSlidingPlatform),
		OBJECT(MODEL_WF_SLIDING_PLATFORM, 3840, 1075, -1792, 0, 0, 0, BPARAM2(WF_SLID_BRICK_PTFM_BP_MOV_VEL_10), bhvWFSlidingPlatform),
		OBJECT(MODEL_WF_SLIDING_PLATFORM, 3840, 1075, -2816, 0, 0, 0, BPARAM2(WF_SLID_BRICK_PTFM_BP_MOV_VEL_20), bhvWFSlidingPlatform),
		OBJECT(MODEL_WF_SMALL_BOMP, 3835, 1070, 0, 0, 0, 0, 0, bhvSmallBomp),
		OBJECT(MODEL_WF_SMALL_BOMP, 3835, 1070, 1229, 0, 0, 0, 0, bhvSmallBomp),
		OBJECT(MODEL_STAR_SWITCH, 3768, 102, -1792, 0, 90, 0, BPARAM2(35), bhvStarSwitch),
		OBJECT(MODEL_NONE, -2560, 538, -2560, 0, 0, 0, BPARAM1(STAR_INDEX_ACT_7), bhvHiddenRedCoinStar),
		OBJECT(MODEL_LEVEL_GEOMETRY_08, 0, 3584, 0, 0, 0, 0, 0, bhvTower),
		OBJECT(MODEL_WF_TOWER_DOOR, -512, 3584, 0, 0, 0, 0, 0, bhvTowerDoor),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, 502, 3891, 502, 0, 45, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, 502, 4096, -502, 0, 135, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, -502, 4301, -502, 0, -135, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, -502, 4506, 502, 0, -45, 0, 0, bhvWFElevatorTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, 0, 3789, 717, 0, 0, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, 732, 3994, 0, 0, 90, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, 0, 4198, -717, 0, 180, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_TOWER_SQUARE_PLATORM, -717, 4403, 0, 0, -90, 0, 0, bhvWFSlidingTowerPlatform),
		OBJECT(MODEL_WF_BUBBLY_TREE, 2560, 256, 4608, 0, 0, 0, 0, bhvTree),
		OBJECT(MODEL_WF_TUMBLING_BRIDGE, 1792, 2495, 1087, 0, 0, 0, BPARAM2(TUMBLING_BRIDGE_BP_WF), bhvTumblingBridge),
		...
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, 5007, 256, 3891, 0, -90, 0, DIALOG_000, bhvBobombBuddy, ACT_1 | ACT_2),
		OBJECT_WITH_ACTS(MODEL_MARIOS_CAP, 2068, 2560, 2806, 0, 0, 0, 0, bhvMarioCap, ACT_1 | ACT_2),
		OBJECT_WITH_ACTS(MODEL_WHOMP, 721, 3584, 722, 0, -135, 0, 0, bhvWhompKingBoss, ACT_1),
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, -1741, 1024, 3584, 0, -90, 0, DIALOG_000, bhvBobombBuddyOpensCannon, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT_WITH_ACTS(MODEL_BOBOMB_BUDDY, 2714, 256, 4454, 0, 90, 0, DIALOG_000, bhvBobombBuddy, ACT_4),
		OBJECT(MODEL_NONE, 3174, 1997, 4506, 0, 90, 0, 0x000A0000, bhvFlyingWarp),
    RETURN(),
};
...
const LevelScript level_wf_entry[] = {
    ...
    AREA(/*index*/ 1, wf_geo_000BF8),
        OBJECT(MODEL_NONE, 3174, 949, 4506, 0, 90, 0, BPARAM2(0x0A), bhvSpinAirborneWarp),
