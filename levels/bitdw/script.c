...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_BITDW_FERRIS_WHEEL_AXLE, -205, 1737, 3381, 0, 0, 0, BPARAM2(1), bhvFerrisWheelAxle),
		...
		OBJECT(MODEL_BITDW_SLIDING_PLATFORM, -5728, 4481, -2151, 0, 0, 0, BPARAM1(3) | BPARAM2(0xCE), bhvSlidingPlatform2),
		OBJECT(MODEL_BITDW_STAIRCASE, 5279, 5403, -6, 0, 0, 0, BPARAM2(1), bhvAnimatesOnFloorSwitchPress),
