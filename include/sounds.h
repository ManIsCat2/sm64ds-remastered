...
#define SOUND_GENERAL_BOING_UNUSED               /* 0x30720001 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x72, 0x00, 0) // unverified, unused
...
#define SOUND_OBJ_UNK23                          /* 0x50238001 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x23, 0x80, 0) // unverified, unused
...
#define SOUND_OBJ_EEL_HIGHPRIO                   /* 0x524A0081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x4A, 0x80, SOUND_VIBRATO | SOUND_DISCRETE)
...
#define SOUND_MENU_PAUSE_SELECT                  /* 0x7002F081 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x02, 0xF0, SOUND_DISCRETE) // unused
