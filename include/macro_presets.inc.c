...
static struct MacroPreset sMacroObjectPresets[] = {
    ...
    /* macro_box_wing_cap                */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_WING_CAP },
    /* macro_box_metal_cap               */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_METAL_CAP },
    /* macro_box_vanish_cap              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_VANISH_CAP },
    /* macro_box_koopa_shell             */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_KOOPA_SHELL },
    /* macro_box_one_coin                */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_ONE_COIN }, // unused
    /* macro_box_three_coins             */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_THREE_COINS },
    /* macro_box_ten_coins               */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_TEN_COINS },
    /* macro_box_1up                     */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_1UP_WALKING },
    /* macro_box_star_act_1              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_STAR_ACT_1 },
    ...
    /* macro_box_1up_running_away        */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_1UP_RUNNING_AWAY },
    ...
    /* macro_box_star_act_2              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_STAR_ACT_2 },
    /* macro_box_star_act_3              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_STAR_ACT_3 },
    /* macro_box_star_act_4              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_STAR_ACT_4 },
    /* macro_box_star_act_5              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_STAR_ACT_5 }, // unused
    /* macro_box_star_act_6              */ { bhvExclamationBox, MODEL_CAP_BOX, EXCLAMATION_BOX_BP_STAR_ACT_6 },
